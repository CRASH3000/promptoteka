...
|:--|:--:|:--|
| Главная | ✅ | Короткая инструкция по работе с Промптотекой |
| Промпт-хаб | 🟡 | Прототип будущего публичного каталога промптов |
| Шаблоны | ✅ | Каталог шаблонов с поиском и фильтрацией |
| Карточка шаблона | ✅ | Просмотр промпта, результата, параметров и лайков |
| Создание шаблона | ✅ | Форма добавления собственной карточки промпта |
| Редактор промпта | ✅ | Быстрые кнопки и предпросмотр подсветки структуры |
...
| Избранное | 🟡 | Прототип будущей личной полки с полезными шаблонами |
