  ...
  return (
    <section className="page-card">
      ...
      <div className="page-card__content">
        ...
        <p>
          Здесь пользователь создаёт собственную карточку промпта. Вместо обычного textarea
          используется компонент редактора с быстрыми кнопками и предпросмотром подсветки.
        </p>
      </div>
